...
export default function Index() {
    ...
    return (
        <Routes>
            ...
            <Route path='/blogs/*' element={(user?.role === "organizer" || user?.role === "admin") ? <Blogs /> : <div className='container py-5 text-center text-danger display-5'> You do not have access to this page. Only organizers and admins can access this page.</div>} />
