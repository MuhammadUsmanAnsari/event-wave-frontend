...
export default function PopularEvents() {
    ...
    // Add this function in your component or in a separate utils file
                        ...
                        return <div className="col d-flex align-items-stretch justify-content-center" key={i}>
                            <div class="card border-0 shadow rounded-4 w-100 overflow-hidden">
                                ...
                                <div class="card-body d-flex flex-column justify-content-between">
                                    ...
                                    {/* <div className='rounded p-3' dangerouslySetInnerHTML={{ __html: truncateHTML(item?.description, 100) }} /> */}
